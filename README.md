...
```bash
# Ubuntu / Debian
sudo apt install libwebkit2gtk-4.1-dev libsoup2.4-dev libjavascriptcoregtk-4.1-dev \
  libssl-dev libgtk-3-dev libayatana-appindicator3-dev librsvg2-dev patchelf

# Fedora
sudo dnf install webkit2gtk4.1-devel libsoup2.4-devel javascriptcoregtk4.1-devel \
